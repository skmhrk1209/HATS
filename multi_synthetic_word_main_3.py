...
from networks.han_3 import HAN
from networks.resnet import ResNet
from algorithms import *

parser = argparse.ArgumentParser()
parser.add_argument("--model_dir", type=str, default="multi_synthetic_word_hats_model_3", help="model directory")
    ...
    classifier = tf.estimator.Estimator(
        model_fn=lambda features, labels, mode: HATS(
            ...
            attention_network=HAN(
                ...
                rnn_params=[
                    AttrDict(sequence_length=5, num_units=[256, 256]),
