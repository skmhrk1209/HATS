...
parser.add_argument('--filenames', type=str, nargs="+", default=["svhn_train.tfrecord"], help="tfrecord filenames")
...
def main(unused_argv):
    ...
    if args.predict:
        ...
        for i, predict_result in enumerate(itertools.islice(predict_results, 10)):
            ...
            cv2.imwrite("outputs/feature_{}.png".format(i), feature * 255.)
            cv2.imwrite("outputs/reduced_attention_map_{}.png".format(i), reduced_attention_map * 255.)
