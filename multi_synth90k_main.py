...
parser.add_argument("--steps", type=int, default=0, help="number of training epochs")
parser.add_argument("--max_steps", type=int, default=0, help="maximum number of training epochs")
