    ...
    if args.predict:
        ...
        for i, predict_result in enumerate(itertools.islice(predict_results, 10)):
            ...
            for j in range(feature_maps.shape[-1]):
                ...
                cv2.imwrite("feature_maps/mnist/{}/{}.png".format(i, j), feature_map)
            ...
            for j in range(attentions.shape[-1]):
                ...
                cv2.imwrite("attentions/mnist/{}/{}.png".format(i, j), attention)
            ...
            cv2.imwrite("images/mnist/{}.png".format(i), image)
