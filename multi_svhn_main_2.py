        ...
        for i, predict_result in enumerate(itertools.islice(predict_results, 10)):
            ...
            for j in range(4):
                ...
                for k in range(4):
                    ...
                    cv2.imwrite("outputs_2/image_{}_{}_{}.png".format(i, j, k), image * 255.0)
                    cv2.imwrite("outputs_2/merged_attention_map_{}_{}_{}.png".format(i, j, k), merged_attention_map * 255.0)
