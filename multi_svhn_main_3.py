...
from networks.hierarchical_recurrent_attention_network_2 import HierarchicalRecurrentAttentionNetwork

parser = argparse.ArgumentParser()
parser.add_argument("--model_dir", type=str, default="multi_svhn_acnn_model_3", help="model directory")
        ...
        for i, predict_result in enumerate(itertools.islice(predict_results, 10)):
            ...
            for j in range(4):
                ...
                for k in range(4):
                    ...
                    cv2.imwrite("outputs_3/image_{}_{}_{}.png".format(i, j, k), image * 255.0)
                    cv2.imwrite("outputs_3/merged_attention_map_{}_{}_{}.png".format(i, j, k), merged_attention_map * 255.0)
